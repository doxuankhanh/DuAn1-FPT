...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand mx-2" href="#">CẬP NHẬT DANH MỤC</a>
    ...
    <main class="m-2">
        <form method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <label for="">ID</label>
                <input type="text" class="form-control" id="" placeholder="" disabled name="id" value="<?= $data['cate']['id'] ?? ''?>">
            </div>
            <div class="form-group">
                <label for="">Tên Sản Phẩm</label>
                <input type="text" class="form-control" id="" placeholder="" name="cateName" value="<?= $data['cate']['cateName'] ?? ''?>">
            </div>
